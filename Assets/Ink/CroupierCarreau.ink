...
Hansel2: Ouais, mais maintenant j'ai une autre idée...
Hansel2: Je connais ce casino.
Hansel2: Du moins sa devanture, mais il était pas ici.

Grethel: Tu veux y aller c'est ça ?

Hansel2: Ouais mais ils m'ont dépouillé la dernière fois par contre j'ai eu du mal à m'arrêter.

Grethel: Et t'es sûr de vouloir y retourner?

Hansel2: C'est la seule solution pour le moment et à cause de ça papa est en train de crever. Si seulement j'avais pas fais le con...

Grethel: Oui mais je n'étais pas la quand ça c'est passé.

Grethel: Si tu m'écoutes je pense qu'on a moyen de s'en sortir sans trop de problème.
...
*[Question 1]->PasEncoreJouer
*[Question 2]->PasEncoreJouer
*[Question 3]->PasEncoreJouer
...
*{not ConvTresNul}[Question 1]->ConvTresNul
*{not ConvNul}[Question 2]->ConvNul
*{not InfoCroupierCoeur}[Question 3]->InfoCroupierCoeur
...
*{not ConvTresNul}[Question 1]->HopHopHop
*{not InfoCroupierCoeur}[Question 3]->HopHopHop
*{not InfoMajordome && DéblocageInfoMajordomeCarreau}[Lui parler de ses voyages]->HopHopHop

-(HopHopHop)
Carreau: Oh, la jeunes gens je vous ai dit une à la fois.
...
===TropDeQuestion
Hansel: Mais nous on aimerait bien faire une autre partie, après tout on a pas jamais assez d'argent.
...
*{not Question1Coeur}[Question 1]->Question1Coeur
*{not Question2Coeur}[Question 2]->Question2Coeur
*{not InfoCroupiertrefle}[Question 3]->InfoCroupiertrefle
...
{Question1CCO >=2:
~Question1CCO -=2
Coeur: Si vous avez une autre question il va falloir jouer malheuresemnt.
->jouerCC0
-else:
Hansel: Pose une autre question pendant que je joue, {c'est pas grave.|ne t'en fais pas.| elle sera vite la pliée.}
~Question1CCO +=1
...
->jouerCC0
-else:
Hansel: Puisqu'on doit rejouer, pose une question pendant que je faiç une partie, elle sera vite la pliée.
~Question1CCO +=1
->HubCC0
}
